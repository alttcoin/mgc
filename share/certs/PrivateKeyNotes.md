...
unlocked to sign the Magneticoin-Qt.app bundle.
...
allowing somebody to distribute a Magneticoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the magneticoin-qt.exe file inside the installer had not been tampered with.
